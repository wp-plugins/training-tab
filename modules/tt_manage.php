<?php
	global $wpdb;
		...
		email_to='$email'
		WHERE id=1");
		echo '<div class="notices">Settings Updated</div>';
		}
		...
		DELETE FROM $table_name WHERE id = $id
					");
		echo '<div class="notices">RECORD DELETED</div>';	
		}
		...
		echo '<div class="notices">RECORD ADDED</div>';
				...
				WHERE id=$id");
		echo '<div class="notices">RECORD UPDATED</div>';
