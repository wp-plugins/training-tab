...
// include includes
include('includes/tt_header.php');
function tt_main(){
include_once('includes/tt_main.php');
}

function tt_manage(){
include_once('includes/tt_manage.php');
}

function tt_request(){
include_once('includes/tt_request.php');
}
...
function tt_scripts() {
    ...
    echo '<link rel="stylesheet" type="text/css" href="' . $prepath . '/css/style.css" />' . "\n";
    wp_register_script('tt_validate','http://techstud.io/js/validate.jquery.js',false,'latest',false);
    wp_enqueue_script('tt_validate');
    wp_register_script('tt_scripts',$prepath . 'js/training-tab.jquery.js',false,'latest',false);
    wp_enqueue_script('tt_scripts');
}

add_action('admin_head', 'tt_scripts');
