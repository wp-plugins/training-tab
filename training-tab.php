...
function plugin_menu() {
	add_menu_page( 'Training', 'Training', 'administrator', __FILE__, 'tt_main' );
	add_submenu_page(__FILE__, 'Manage', 'Manage', 'administrator', 'tt-manage', 'tt_manage');
	add_submenu_page(__FILE__, 'Request', 'Request', 'administrator', 'tt-request', 'tt_request');
}
